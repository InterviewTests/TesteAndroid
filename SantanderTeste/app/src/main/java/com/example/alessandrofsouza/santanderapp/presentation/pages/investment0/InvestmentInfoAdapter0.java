...
class InvestmentInfoAdapter0 extends RecyclerView.Adapter<InvestmentInfoAdapter0.ViewHolder> {


    private static final String TAG = "Santander ";
    private ArrayList<Infos> dataSet;

    public InvestmentInfoAdapter0() {
    ...
    @Override
    public void onBindViewHolder(@NonNull final InvestmentInfoAdapter0.ViewHolder viewHolder, int i) {
