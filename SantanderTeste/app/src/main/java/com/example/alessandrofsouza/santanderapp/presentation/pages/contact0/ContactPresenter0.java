...
public class ContactPresenter0 implements ContactContract0.Presenter{

    private static final String TAG = "Santander ";
    private ContactContract0.View view;
    private ApiService service;

    public ContactPresenter0(@NonNull ContactContract0.View contractView) {
        view = contractView;
