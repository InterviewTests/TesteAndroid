...
import com.galdino.testandroid.data.source.local.LocalDataSource
...
val appModule = module {
    ...
    factory { LocalDataSource(androidApplication()) as ILocalDataSource }
    factory { RepositoryImpl(get(),get(), get()) as IRepository }
