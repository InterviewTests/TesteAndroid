...
import br.com.santander.santanderinvestimento.feature.contact.domain.TypeField
...
class ContactFragment : BaseFragment(), ContactContract.View, SwipeRefreshLayout.OnRefreshListener {
    ...
    override fun showSuccess(contract: List<Contact>) {
        contactForm.removeAllViews()
        successForm.visibility = View.INVISIBLE
        layoutMain.visibility = View.VISIBLE
        this.contactList = contract
        contactViewModel.setContactList(contract)
            ...
            when (contact.type) {
                        ...
                        TypeField.TEXT -> {
                            ...
                            textInputEditText.addTextChangedListener(object : TextWatcher {
                                ...
                                override fun onTextChanged(s: CharSequence, start: Int, before: Int, count: Int) {
                                    ...
                                    contactViewModel.updateObjectList(contact)
                                }
                ...
                Type.CHECKBOX -> {
                    ...
                    typeComponent.setOnCheckedChangeListener { buttonView, isChecked ->
                        ...
                        contactViewModel.updateObjectListHidden(contact)
                    }
                }
                Type.SEND -> {
